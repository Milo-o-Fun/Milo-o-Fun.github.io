...
/** @type {string} */
const CACHE_VERSION = '1722865510|1081709088';
/** @type {string} */
const CACHE_PREFIX = 'Milo-o.fun-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'milo-o.fun.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["milo-o.fun.html","milo-o.fun.js","milo-o.fun.offline.html","milo-o.fun.icon.png","milo-o.fun.apple-touch-icon.png","milo-o.fun.worker.js","milo-o.fun.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["milo-o.fun.wasm","milo-o.fun.pck"];
